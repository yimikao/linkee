    ...
    <div class="container">
        <div class="row">
            <div class="col-12 card">
                <div class="card-body">
                    <h2 class="card-title">Update link</h2>
                    <form action="/dashboard/links/{{ $link->id }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <button onclick="event.preventDefault(); document.getElementById('delete-form').submit();" type="button" class="btn btn-secondary">Delete Link</button>
                            </div>
                        </div>
                    </form>
